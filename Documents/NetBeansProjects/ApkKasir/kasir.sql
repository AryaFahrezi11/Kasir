...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 26 Okt 2024 pada 06.41
...
(2410001, 'ayam', 200.00, 800.00, 30, 'Kg'),
(2410002, 'sapi', 200.00, 300.00, 30, 'Pack'),
(2410003, 'kerbau', 20.00, 100.00, 1, 'Pcs');
...
(1, 'bram', 'aryama@gmail.com', 877666660, 'admin', 'admin123', 'admin'),
(2410001, 'ilma', 'ILMA', 988, 'ilma', 'ilma123', 'KASIR');
...
--
ALTER TABLE `produk`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2410006;
...
--
ALTER TABLE `user`
  MODIFY `id_user` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2410002;
