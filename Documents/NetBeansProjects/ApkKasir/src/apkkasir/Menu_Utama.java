...
public class Menu_Utama extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panel_navbar.setBackground(new java.awt.Color(0, 0, 102));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Menu_Utama(nama, level, mail, tlp, id).setVisible(true);
...
//        MenuItem menuTransaksi = new MenuItem(iconMaster, false, null, "Transaksi", null, masTransaksi, masTransaksi2, masTransaksi3);
        MenuItem menuHome    = new MenuItem(iconMaster, false, null, "Home", (ActionEvent e) -> {
        ...
        MenuItem menuTransaksi    = new MenuItem(iconTransaksi, false, null, "Transaksi", null);
